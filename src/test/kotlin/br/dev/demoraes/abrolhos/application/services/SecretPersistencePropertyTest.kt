 ...
 *
 * **Property 4: Secret Persistence on Invite Validation** **Validates: Requirements 4.1**
 *
 * This test verifies that when an invite is validated without a persisted secret, the system
 * generates a new secret, validates it, and persists it to the database.
 *
...
class SecretPersistencePropertyTest {
    ...
    /**
     * Property: For any invite without a persisted secret, validateInvite should generate and
    ...
    /**
     * Property: For any invite with an existing persisted secret, validateInvite should reuse the
     * existing secret without generating a new one or persisting again.
     *
     * This property verifies that:
    ...
    /**
     * Property: For any invite without a secret, if secret validation fails, the system should
     * throw an exception and not persist the invalid secret.
     *
     * This property verifies that:
